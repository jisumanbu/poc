...
public class MqProducer {
    ...
    public static SendResult sendMsg(String msgContent, String topic, String tags) throws Exception {
        Message msg = null;
        SendResult sendResult = null;
        try {
            msg = new Message(topic, tags, msgContent.getBytes(RemotingHelper.DEFAULT_CHARSET));
        ...
        if (msg != null) {
            try {
                ...
                //just log exception, then throw it out.
                e.printStackTrace();
                throw e;
            }
        }
